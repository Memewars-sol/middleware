...
export async function cancelProposal(realmPk: PublicKey, ownerPk: PublicKey, governanceAuthorityPk: PublicKey, proposal: ProgramAccount<Proposal>) {
    // let governanceAuthority = owner.publicKey;
